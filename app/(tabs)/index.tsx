  ...
  return (
    <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
      <YStack gap="$4">
        ...
        <XStack items="center" gap="$2" borderWidth={1} borderColor="$borderColor" bg="$background" rounded={16} p="$3">
          ...
          return (
            ...
            >
              ...
              <XStack items="center" gap="$2">
                <YStack rounded={999} px="$2.5" py="$1" bg={metricToneView.backgroundColor}>
