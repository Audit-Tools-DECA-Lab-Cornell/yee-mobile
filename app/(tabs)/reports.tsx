...
export default function ReportsScreen() {
    const [scoreView, setScoreView] = useState<ScoreView>("weighted");
        ...
        <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
            ...
            >
                ...
                <Text
                    fontSize={22}
                    fontWeight="700"
                    color={weightedLift >= 0 ? "$green10" : "$red10"}
                >
                    {weightedLift >= 0 ? "+" : ""}
                    {weightedLift} points
                </Text>
 ...
 */
function calculateAverageScore(rows: readonly ReportComparisonRow[], scoreView: ScoreView): number {
    if (rows.length === 0) {
        return 0;
    }
