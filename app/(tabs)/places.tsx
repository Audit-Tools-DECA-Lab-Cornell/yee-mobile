    ...
    <ScrollView contentContainerStyle={{ padding: 16, gap: 16 }}>
      <YStack gap="$4">
        ...
        <Paragraph color="$color10">
          Browse assigned places with base vs weighted score tracking and mandatory completion.
        </Paragraph>
        <RoleToggle />
        <XStack gap="$2">
          <YStack flex={1} borderWidth={1} borderColor="$blue6" rounded={12} p="$3" bg="$blue2">
          ...
          return (
            ...
            >
              ...
              >
                ...
                <XStack rounded={999} px="$3" py="$1.5" bg={preAuditStatus.backgroundColor}>
