      ...
      >
        <YStack gap="$4">
          ...
          <Paragraph color="$color10">
            In-field audit preview with mandatory coverage and weighted section awareness.
          </Paragraph>
          <RoleToggle />
        </YStack>
        ...
        <YStack gap="$3">
          {AUDIT_SECTION_PREVIEW.map((section) => {
            const completion = toCompletionPercent(section.answeredItems, section.totalItems);
            ...
            return (
              ...
              >
                <XStack justify="space-between" items="center">
                  ...
                  <XStack rounded={999} px="$3" py="$1" bg={section.mandatory ? "$orange4" : "$blue4"}>
                    <Paragraph color={section.mandatory ? "$orange10" : "$blue10"} fontWeight="700">
                      {section.mandatory ? "Mandatory" : "Optional"} · {section.weightLabel}
                    </Paragraph>
                  </XStack>
                </XStack>
        ...
        >
          ...
          <Paragraph color="$color10">
            To what extent does this place enable youth participation and shared decision-making?
          </Paragraph>
          <XStack gap="$2">
            {[1, 2, 3, 4, 5].map((value) => {
          ...
          <XStack gap="$3">
            <YStack flex={1} borderWidth={1} borderColor="$borderColor" rounded={12} p="$3">
          ...
          <XStack items="center" gap="$2">
            ...
            <Paragraph color="$green10">
              ...
              {mandatoryCompletion >= 80 ? "ready for submission" : "still in progress"}.
            </Paragraph>
          </XStack>
        </YStack>
      </ScrollView>
        ...
        {activeRole === "manager" ? (
          ...
          >
            ...
            <Paragraph color="$orange10">
              Manager mode is read-only. Auditor mode enables full in-field response capture.
            </Paragraph>
          </XStack>
        ) : null}
        <XStack gap="$2">
